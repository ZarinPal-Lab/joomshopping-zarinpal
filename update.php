...
$values = array($db->q('TrangellZarinpal'), $db->q('TrangellZarinpal'), $db->q(''), $db->q(''), $db->q('trangellzarinpal'), $db->q('pm_trangellzarinpal'), $db->q('pm_trangellzarinpal'), $db->q(0), $db->q(2), $db->q('merchant_id='), $db->q(2), $db->q(1), $db->q(0), $db->q(0),$db->q('TrangellZarinpal'));
